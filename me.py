...
class Person:
    ...
    resume_sections: Dict[str, List[str]] = field(default_factory=dict)
    ...
    def add_resume_section(self, title: str, bullets: List[str]):
        self.resume_sections[title] = bullets
    ...
    def print_info(self):  # noqa: C901 (long but readable CLI output)
        ...
        # Résumé Sections (imported from Notion)
        if self.resume_sections:
            print(f"{Fore.GREEN}Résumé Highlights{Style.RESET_ALL}")
            for title, items in self.resume_sections.items():
...
def build_victor() -> Person:
    ...
    victor = Person(
        ...
        skills=[
            ...
            Skill("Programming", 4.5, 4.8, 5.0),
            Skill("Cybersecurity", 4.7, 4.9, 5.0),
            # Specialist
            Skill("Web application security", 4.7, 4.9, 5.0),
    ...
    # Defensive / hybrid tools
    victor.programs.extend([
    ...
    victor.programs.extend([
        ...
        Program("masscan", "Offensive/Defensive", "Open-source", "Lightning-fast port scanner"),
        ...
        Program("Responder", "Offensive", "Open-source", "LLMNR/NBT-NS poisoner"),
        Program("Bettercap", "Offensive", "Open-source", "Network attack toolkit"),
        Program("BloodHound", "Offensive", "Open-source", "AD privilege escalation mapper"),
        Program("mimikatz", "Offensive", "Open-source", "Credential dumper for Windows"),
        Program("enum4linux-ng", "Offensive", "Open-source", "SMB/Windows enumeration"),
        ...
        Program("hashcat", "Offensive", "Open-source", "GPU-accelerated password cracker"),
        Program("John the Ripper", "Offensive", "Open-source", "Password cracker"),
    ])

    # Résumé highlights (concise extract from Notion page)
    victor.add_resume_section("History", [
    ...
    victor.add_resume_section("Technical experience", [
    ...
    victor.add_resume_section("Strengths", [
